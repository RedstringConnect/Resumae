  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-black rounded-3xl overflow-hidden">
      ...
      {suggestions.length > 0 && (
        <div className="px-4 py-2.5 border-t border-gray-200 dark:border-[#2c2c2d] bg-white dark:bg-black">
          <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-2 font-medium">
            Quick suggestions:
          </p>
          <div className="flex flex-wrap gap-1.5">
            {suggestions.slice(0, 3).map((suggestion, index) => (
              <button
                ...
                className="text-[11px] px-2.5 py-1 rounded-md bg-gray-50 dark:bg-black border border-gray-200 dark:border-[#2c2c2d] text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors"
              >
                {suggestion}
              </button>
            ))}
